        ...
        stage('artifactory trivy result to nexus') {
            steps {
                sh '''
                        ...
                        curl --fail -u $NEXUS_CREDENTIALS_USR:$NEXUS_CREDENTIALS_PSW --upload-file result_${BUILD_NUMBER}.txt 'https:/nexus.winters-tek.net:8081/repository/raw-host/${BUILD_NUMBER}/result_${BUILD_NUMBER}.txt'      
